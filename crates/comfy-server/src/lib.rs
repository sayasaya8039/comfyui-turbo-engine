...
/// Build a fully-configured axum Router with all ComfyUI-compatible routes.
///
/// This is the primary entry point for both the binary and integration tests.
...
///
/// Useful when you need to customize the state (e.g. custom base_path).
